...
A preceding provisional nonlinear comparison used the saved full-sample masks and global standardization for support vector regression with a Gaussian kernel, random forests, and gradient-boosted trees (Drucker et al., 1997; Breiman, 2001; Friedman, 2001). Its primary paired comparison was the Nadeau--Bengio corrected resampled $t$-test. Because it has not been rerun after the latest state, feature, and ridge update, no current nonlinear result is reported.
