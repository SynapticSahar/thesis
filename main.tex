...
A general cognitive factor, $g$, used ten indicators:
{\centering
\scriptsize
\begin{tabular}{@{}lll@{}}
...
\end{tabular}
\par}
Indicators were z-scored across complete cases. MATLAB \texttt{factoran} fitted a one-factor
model by maximum likelihood. Its sign was oriented to correlate positively with the mean
standardized test score. One participant had incomplete
data, giving $N=181$ for $g$ (Spearman, 1904).
