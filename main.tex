...
% Readable panel labels for composite figures.
\newcommand{\panelletter}[1]{%
  \begingroup\setlength{\fboxsep}{1.5pt}%
  \colorbox{white}{\textcolor{black}{\bfseries\large #1}}%
  \endgroup}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a01_state_atlas.png}
\put(1,94){\panelletter{A}}\put(34,94){\panelletter{B}}\put(68,94){\panelletter{C}}
\put(1,55){\panelletter{D}}\put(68,55){\panelletter{E}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a02_state_dynamics.png}
\put(1,94){\panelletter{A}}\put(34,94){\panelletter{B}}\put(67,94){\panelletter{C}}
\put(1,62){\panelletter{D}}\put(34,62){\panelletter{E}}\put(67,62){\panelletter{F}}
\put(1,30){\panelletter{G}}\put(34,30){\panelletter{H}}\put(67,30){\panelletter{I}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a03_gmm_validation.png}
\put(1,94){\panelletter{A}}\put(34,94){\panelletter{B}}\put(67,94){\panelletter{C}}
\put(1,62){\panelletter{D}}\put(34,62){\panelletter{E}}\put(67,62){\panelletter{F}}
\put(1,30){\panelletter{G}}\put(34,30){\panelletter{H}}\put(67,30){\panelletter{I}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a04_gmm_overlap_k7.png}
\put(1,94){\panelletter{A}}\put(51,94){\panelletter{B}}
\put(1,48){\panelletter{C}}\put(51,48){\panelletter{D}}
\end{overpic}
...
\begin{figure}[htbp]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a05_surrogate_nulls.png}
\put(1,94){\panelletter{A}}\put(51,94){\panelletter{B}}
\put(1,62){\panelletter{C}}\put(51,62){\panelletter{D}}
\put(1,30){\panelletter{E}}\put(51,30){\panelletter{F}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a06_surrogate_signflip.png}
\put(1,94){\panelletter{A}}\put(51,94){\panelletter{B}}
\put(1,48){\panelletter{C}}\put(51,48){\panelletter{D}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a07_geometry_group_fit.png}
\put(1,94){\panelletter{A}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a08_geometry_loocv.png}
\put(1,94){\panelletter{A}}\put(51,94){\panelletter{B}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a09_geometry_cognition.png}
\put(1,94){\panelletter{A}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a10_dwell_bias.png}
\put(1,94){\panelletter{A}}\put(26,94){\panelletter{B}}\put(51,94){\panelletter{C}}\put(76,94){\panelletter{D}}
\put(1,62){\panelletter{E}}\put(26,62){\panelletter{F}}\put(51,62){\panelletter{G}}\put(76,62){\panelletter{H}}
\put(1,30){\panelletter{I}}\put(26,30){\panelletter{J}}\put(51,30){\panelletter{K}}\put(76,30){\panelletter{L}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a11_binary_mop.png}
\put(1,94){\panelletter{A}}\put(26,94){\panelletter{B}}\put(51,94){\panelletter{C}}\put(76,94){\panelletter{D}}
\put(1,62){\panelletter{E}}\put(26,62){\panelletter{F}}\put(51,62){\panelletter{G}}\put(76,62){\panelletter{H}}
\put(1,30){\panelletter{I}}\put(26,30){\panelletter{J}}\put(51,30){\panelletter{K}}\put(76,30){\panelletter{L}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a12_stay_switch_mop.png}
\put(1,94){\panelletter{A}}\put(21,94){\panelletter{B}}\put(41,94){\panelletter{C}}\put(61,94){\panelletter{D}}\put(81,94){\panelletter{E}}
\put(1,62){\panelletter{F}}\put(21,62){\panelletter{G}}\put(41,62){\panelletter{H}}\put(61,62){\panelletter{I}}\put(81,62){\panelletter{J}}
\put(1,30){\panelletter{K}}\put(21,30){\panelletter{L}}\put(41,30){\panelletter{M}}\put(61,30){\panelletter{N}}\put(81,30){\panelletter{O}}
\end{overpic}
...
\begin{figure}[htbp]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a13_entropy_scatterplots.png}
\put(1,94){\panelletter{A}}\put(34,94){\panelletter{B}}\put(67,94){\panelletter{C}}
\put(1,48){\panelletter{D}}\put(34,48){\panelletter{E}}\put(67,48){\panelletter{F}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a14_entropy_partial_sensitivity.png}
\put(1,94){\panelletter{A}}\put(34,94){\panelletter{B}}\put(67,94){\panelletter{C}}
\put(1,48){\panelletter{D}}\put(34,48){\panelletter{E}}\put(67,48){\panelletter{F}}
\end{overpic}
...
\begin{figure}[p]
\centering
\begin{overpic}[width=\textwidth]{figures/appendix/a15_entropy_cognition_heatmap.png}
\put(1,94){\panelletter{A}}
\end{overpic}
