...
\newcommand{\appendixpanelgraphic}[1]{%
  \includegraphics[
    width=\textwidth,
...
\newcommand{\appendixfirstpanelgraphic}[1]{%
  \includegraphics[
    width=\textwidth,
...
\newcommand{\appendixdensepanelgraphic}[1]{%
  \includegraphics[
    width=\textwidth,
...
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixfirstpanelgraphic{figures/appendix/a01_state_atlas.png}};
...
\textbf{(A)} K-means inertia;
\textbf{(B)} mean silhouette width;
\textbf{(C)} state sizes;
\textbf{(D)} centroid profiles in local-synchronization space; and
\textbf{(E)} state labels in the first two principal components.
The seven-state solution is the working atlas, not evidence for an optimal discrete partition.}
\label{fig:app-state-atlas}
\vspace{0.5em}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixfirstpanelgraphic{figures/appendix/a02_state_dynamics.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\node[panel label] at (0.34,0.98) {B};
...
\textbf{(A--C)} Example state sequences;
\textbf{(D)} distance from the assigned centroid;
\textbf{(E)} participant-by-state occupancy;
\textbf{(F)} mean occupancy;
\textbf{(G)} pooled transition matrix;
\textbf{(H)} switch-rate distribution; and
\textbf{(I)} state-specific dwell distributions.}
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixpanelgraphic{figures/appendix/a03_gmm_validation.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\node[panel label] at (0.34,0.98) {B};
\node[panel label] at (0.67,0.98) {C};
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixpanelgraphic{figures/appendix/a04_gmm_overlap_k7.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixpanelgraphic{figures/appendix/a05_surrogate_nulls.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\node[panel label] at (0.51,0.98) {B};
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixpanelgraphic{figures/appendix/a06_surrogate_signflip.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\node[panel label] at (0.51,0.98) {B};
\node[panel label] at (0.01,0.49) {C};
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixpanelgraphic{figures/appendix/a07_geometry_group_fit.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixpanelgraphic{figures/appendix/a08_geometry_loocv.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\node[panel label] at (0.51,0.98) {B};
\end{scope}
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixdensepanelgraphic{figures/appendix/a09_geometry_cognition.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixdensepanelgraphic{figures/appendix/a10_dwell_bias.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixdensepanelgraphic{figures/appendix/a11_binary_mop.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\node[panel label] at (0.26,0.98) {B};
\node[panel label] at (0.51,0.98) {C};
...
\textbf{(A)} Empirical matrix;
\textbf{(B)} pure-MOP prediction;
\textbf{(C)} dispersion-cost prediction;
\textbf{(D)} fitted-matrix difference;
\textbf{(E)} pure-MOP fit;
\textbf{(F--G)} dispersion-model full and diagonal fits;
\textbf{(H)} full-sample likelihood;
\textbf{(I)} correlations;
\textbf{(J)} diagonal performance;
\textbf{(K)} retained destination cost; and
\textbf{(L)} held-out improvements.}
\label{fig:app-binary-mop}
\vspace{0.5em}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixdensepanelgraphic{figures/appendix/a12_stay_switch_mop.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
...
\textbf{(A)} Full empirical matrix;
\textbf{(B)} empirical switch routing;
\textbf{(C--D)} topology-only and dispersion-cost policies;
\textbf{(E--F)} their routing fits;
\textbf{(G--H)} group routing NLL and metrics;
\textbf{(I--J)} retained destination cost and stay gates;
\textbf{(K--L)} two-stage NLL and correlations;
\textbf{(M)} held-out routing improvement;
\textbf{(N)} held-out two-stage MOP improvement; and
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixpanelgraphic{figures/appendix/a13_entropy_scatterplots.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\node[panel label] at (0.34,0.98) {B};
\node[panel label] at (0.67,0.98) {C};
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixpanelgraphic{figures/appendix/a14_entropy_partial_sensitivity.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\node[panel label] at (0.34,0.98) {B};
\node[panel label] at (0.67,0.98) {C};
...
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0)
  {\appendixpanelgraphic{figures/appendix/a15_entropy_cognition_heatmap.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\node[panel label] at (0.01,0.98) {A};
\end{scope}
\end{tikzpicture}
